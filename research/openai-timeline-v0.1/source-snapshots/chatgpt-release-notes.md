...
URL Source: https://help.openai.com/en/articles/6825453-chatgpt-release-notes

Markdown Content:
[![Image 3: OpenAI](https://help.openai.com/logo.png)](https://help.openai.com/en)

Language English

[Login](https://help.openai.com/auth/login?redirectTo=%2Fauth%2Flogin-success%3FreturnTo%3D%252Fen%252Farticles%252F6825453-chatgpt-release-notes)
...
[Learn more about plugins and the new plugin directory.](https://help.openai.com/en/articles/20001256-plugins-in-chatgpt-and-codex)
...
## **Introducing GPT-Live-1 in ChatGPT Voice**

We’re rolling out a new ChatGPT Voice experience. ChatGPT Voice is now powered by GPT-Live-1 for paid users and GPT-Live-1 mini for Free users. Both models can listen and speak at the same time, making turn-taking and interruptions feel more natural.

GPT-Live-1 works inside a ChatGPT chat, with spoken responses appearing alongside streamed text. It can use web search and memory, show visual results through supported widgets, and work with text and images in the same conversation.

GPT-Live-1 is rolling out across consumer plans, including Free, on chatgpt.com and the ChatGPT iOS and Android apps in supported regions. It is not available in ChatGPT Business, Enterprise, or Edu workspaces at launch. GPT-Live-1 does not support video or screen sharing at this time; eligible subscribers can continue using those capabilities with Advanced Voice Mode.
...
The new [DigitalOcean Droplet Workspace plugin](https://chatgpt.com/plugins/share/5dc672c7116c44ff92595d48e72df522) lets Codex provision a DigitalOcean Droplet, configure SSH access, and connect it to the Codex app as a remote workspace. Users should update the ChatGPT mobile app and Codex app to the latest versions before connecting. [Learn more about using Codex with a ChatGPT plan](https://help.openai.com/articles/11369540).

# June 24, 2026

## **GPT-5.5 Instant Update**

We’re updating GPT-5.5 Instant, our most-used model in ChatGPT, to improve conversational quality—especially when users are making a decision, asking for advice, planning something, researching options, or shopping.

The model is better at identifying the underlying goal behind a question and carrying context across multiple turns. It also follows complex instructions more reliably: when a request includes several constraints or requirements, responses are more likely to address all of them and clearly explain why a recommendation is a good fit.

When users add constraints, clarify what they mean, or push back on an answer, the model should adapt more effectively instead of repeating its original approach.

Shopping and local business queries should also feel more useful. The model makes better use of location context to surface relevant nearby options and can bring together product recommendations, business information, and images more coherently when those elements are helpful.

Overall, responses should feel more tasteful and cohesive. Formatting is less templated and more intentionally designed, with greater creativity alongside better restraint.
...
*   **Help with pronunciations**: ChatGPT can now include text and audio pronunciation guidance for words in more than 60 languages. Ask how to pronounce a word and ChatGPT can explain it with both audio and text in the conversation.

*   **World Cup updates**: ChatGPT can now help you follow the tournament in a more conversational way. Ask about schedules, matchups, teams and players, country storylines, predictions, and what different match outcomes mean. Get started at [chatgpt.com/football](https://chatgpt.com/football).

*   **App permission controls**: You can now choose when ChatGPT asks before using connected apps. Set ChatGPT to always ask, ask before making changes, or only ask before important changes. Manage preferences in Settings > Apps.

### **Web**

*   **Easier pinning and sidebar organization**: It’s now easier to keep important work close in ChatGPT. You can pin chats and projects directly from the sidebar, and your Pinned section now includes both chats and projects. You can also organize Recents as one combined list, or group chats by project so related work stays together.

*   **Easier conversation sharing**: Sharing a conversation is now faster, with a one-click flow that no longer opens a separate pop-up.

*   **Create a note from a response**: Highlight text in a ChatGPT response and choose ‘Start writing’ to keep working on it, or save it to your Library to come back to later.
...
*   **Long-press send to choose a model**: Android users on paid plans can now long-press the send button to choose a model for a one-off message without changing their default model.

*   **Updated composer and tools menu**: The composer in Android now has inline mentions, and an updated menu for Plugins.
...
Record & Replay requires Computer Use to be available and enabled, and initial availability excludes the European Union, UK and Switzerland. Learn more in the [Record & Replay guide](https://developers.openai.com/codex/record-and-replay).

# **June 17, 2026**

## **Scheduled tasks in ChatGPT**

With scheduled tasks, users can ask ChatGPT to send reminders, handle recurring work, or monitor things for them. This update makes tasks easier to find and manage, faster and more reliable, with more useful notifications.
...
*   Rolling out to Plus, Pro, Business, and Enterprise users.

*   Active task limits vary by tier.

*   Tasks cannot run more than once per hour, and unattended tasks may automatically pause after a period of inactivity.
...
## **Additional controls for memory summary**

You can now delete the memories shown on your memory summary page and turn memory off by selecting “Delete and turn off memory” from the three-dot menu. This does not delete your past chats. If you turn memory back on later, ChatGPT may create new memories from chats that remain in your chat history. This control is available to all ChatGPT users on the web and rolling out on mobile soon.

To make changes to your memory summary, you can:

*   Type what you want changed into the text box at the bottom of the memory summary, and it will update accordingly.

*   Highlight any text in the memory summary to make a specific correction.

If you don’t want information from a chat to be used to personalize responses, you can turn off memory or use Temporary Chat. Temporary Chats don’t use existing memories or create new memories.

Memory updates, including memory summary, are still rolling out across ChatGPT plans and countries. You’ll be notified in ChatGPT when memory updates are available to you.
...
*   Eligible Plus and Pro users now have rate-limit reset banking, including one free reset at launch and the ability to send referral invitations form within the Codex app. When an eligible recipient sends their first Codex message, both people receive a banked rate-limit reset. Banked resets are usable for 30 days after they are granted. Learn more in [Invite friends and coworkers](https://developers.openai.com/codex/pricing#invite-friends-and-coworkers) and review the [current terms](https://help.openai.com/en/articles/20001271).

*   This release also adds [Developer mode](https://developers.openai.com/codex/app/browser#developer-mode) for Browser use in Chrome and the Codex in-app browser. Developer mode gives Codex controlled Chrome DevTools Protocol access so it can profile JavaScript, inspect console output and network traffic, review page state such as the DOM and applied styles, and diagnose live browser issues. The feature is off by default - users can toggle the feature from Codex app settings.

Other changes in this release include the `/init` command for generating an AGENTS.md project-instructions scaffold, customizable macOS Dock icons, an **Unread chats** section in the command menu, and clearer usage-limit errors with plan and workspace guidance, including reset timing when available. [Learn more](https://developers.openai.com/codex/changelog).
...
*   Extra High _[Pro plans only]_

*   Pro Standard _[Pro plans only]_

*   Pro Extended _[Pro plans only]_

![Image 4: Simplified model picker](https://images.ctfassets.net/j22is2dtoxu1/33WX9pLdkbnk3KR2RQDuEN/41874f8230fe2df9723ca287bd6b707f/Screenshot_2026-06-10_at_13.35.41_2x__1_.png)
...
![Image 5: Mobile auto-switch setting](https://images.ctfassets.net/j22is2dtoxu1/64Gf8j77BNSukeU1nJS3kN/c48d8a86b16dfb1adccd713590a4514a/82e4d502-296c-44e8-9823-ea10f9b0593a.png)
...
Today we’re rolling out _Your Year with ChatGPT_, an optional, personalized end-of-year experience that reflects on how you interacted with ChatGPT in 2025. It highlights high-level themes from your conversations and includes summary statistics about your usage over the year.
...
To see _Your Year with ChatGPT_, Memory and Reference Chat History must be turned on, and you must meet a minimum activity threshold. If you have very limited activity, you’ll only see basic chat statistics.
...
_Note: GPT-5-Codex is not currently supported in ChatGPT or the API._
...
This was previously made available to Pro users on [August 12, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4da46a695f).
...
The Advanced Voice upgrades [we announced on June 7th](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d1dfd7dad4) are now rolling out to ChatGPT free users too. With the same improvements available to paid users, ChatGPT sounds more natural and expressive, and can translate more effectively. Rate limits for free users stay the same.
...
*   GPTs _without Custom Actions_ can use the model picker to select from all models available to the user.

*   GPTs _with Custom Actions_ currently support GPT-4o and 4.1
...
![Image 6: Recommended Model setting with o3 selected as the default model](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-42c382e8919222ca76fb3a1a/11e141f2c5d0a0d45437e44cf726bfdc/image.png)
...
![Image 7: Chart of o3-pro win rate vs o3, with human testers preferring o3-pro across all query categories](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e5b17caf2d426949b0749916/bd6e50fc647b699b51a6dd84c2f81eb6/image.png)

Academic evaluations show that o3-pro consistently outperforms both o1-pro and o3.

![Image 8: OpenAI o3-pro benchmark chart outperforming o1-pro and o3 (medium) on AIME 2024, GPQA Diamond, and Codeforces](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-381dac8c40ab4bae4fbadb2f/ab87c7eae026218222dd1ec4d757d4bd/image.png)
...
![Image 9: Benchmark chart where o3-pro leads o1-pro and o3 (medium) on AIME 2024, GPQA Diamond, and Codeforces](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-bb477e0a041adca52db04dd5/ff20bc9bfde296996ecfa558b7519a2a/image.png)
...
*   Free users in EEA (EU + UK), Switzerland, Norway, Iceland, or Liechtenstein will see a prompt to enable this setting or can visit _Settings_>_Personalization_>_Memory_>_Reference chat history_ to enable.
...
![Image 10: ChatGPT mobile Ask anything composer with add, tools, microphone, and voice mode buttons](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-5affc4bc052d8e7034e240fc/0a19be2b1c650cab5eaecd91143d9ab2/image__281_29.png)
...
![Image 11: ChatGPT conversation with a failed response and Retry button](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-3cdd73618024ab8950e30ac5/63ed4f5164447ba41afc7a326ed2adbf/AD_4nXdzDpE-gfBWvrTQ87epy-HFIBZldhIjPOvtbEoWmbMHDfT0CBojbDIc3uHIDouK1G5QLc17tafodtwwjozI9OyK56OY9YCh6FPmR3MzaayL19FbP34OlZnSM_4z)
...
![Image 12: ChatGPT Projects conversation list with a draft reply being composed](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e234e8814f49a4f008de09da/9017a712fc65a125e63f6439bd312121/convo_drafts.gif)

4. New UI for Temporary Chats: We’ve made accessing and viewing these private conversations more clear.

![Image 13: ChatGPT Temporary Chat mode active, noting chats are not saved to history or memory](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-d7c2ef7a8ad4833087c4481c/748154b0700350adf747066df56f8528/AD_4nXcagUHzhFAJ77sucpXjut4iqJGpQQgnecvFpczN2Z8pb7e8jj3iMRRAQ3VDBtO9whmiwlI7SrycQgB05V0YsGI8Uz6TEHE25VoE6j1-T3Oy16p2dwZU1FFlNGOu)

## Android App

1. Increased the default size for in‐line generated images.

![Image 14: Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e5efbee0ae42235cf5459bfd/308fcc2dec9e7b05cf9aa9ae7782ee82/AD_4nXdMb6umeD6hhe5C8CLCWVjjuovVrK2CvIc_pgDMOV14KWP2piNgaXSUPmO3EZ1Kh1V2vreRtSt77uH2Vw6pKsm18Ikw_1Loz53akTT7w6ObJ2F2xrpRRk9C1ls9)

2. More clear and private Incognito keyboard for Temporary Chats.

![Image 15: ChatGPT Android app Temporary chat screen with notice that chats are not saved to history or used to train models](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-fb83fbf1e96cc973c83c0f86/b335948401867a75210802958bec9f6f/AD_4nXccArn8klVtK-yRYmHTRf2SAIxhtBeF7HOrqJJRYEPjSzY6_oKWXcKyOu_Mzm1hKgr3QemFA4irLzkqokWC6dYD4xNK8xBncOXBHbeuUfHDvb4c4SImBliYLuf2)

## iOS App

1. Improved table-copying functionality out of ChatGPT responses on iOS and macOS.

![Image 16: ChatGPT 4o research response with a grocery price table copied into Google Sheets](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-af23d1c6c707122243cfa480/81e43efab6b2a56f5fe1cd38295f2bb2/AD_4nXdKLHEesAx8oF4R4LNwsIgftAV0zc_d72fTxfw_jms5REbzzBa7Qau2In4B2PDlbNl6L4S30pf_Y-7EdoElm6i3KmIeMrwhf03vZZ3L3l0YkgWQhwKVv13qtZyo)

2. Added long press on your message to open menu actions: Copy, Edit.

![Image 17: What’s new? prompt with a context menu offering Copy and Edit](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-75cfda33f0afb2db20b05f32/04d5bc4e95fc686709b9c9302e308729/AD_4nXeVpORC8zTP-D3ctiYCgHwyW3cINg2DuLzYdAEt3VOK0VKvBAWJQ1lhpz0ThkfcgLNtmQjg1rdQ3LQspcFnrbeAYgZgHN2dTGoj3c7AtHvHLPyTcWkO4JEcJyTP)

3. Improved response display of nested blockquote content.

![Image 18: ChatGPT mobile chat with examples of Markdown blockquotes](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-9d8031745ca40a3c54808a14/e42233b1a915797d327c475633a5600c/AD_4nXdx0xvUMu7k2329Y9KWsEzX-7r6dYFy7XuZFHETFnGWCLWWhPdFrDFzuALMTQwLjAmxpJuFUmSRYkTuG01qn-iJcV5MggMPqwuZs647yXrq4ey6t3xtxf8Ejv_d)

4. Improved display and faster streaming of conversations and message menu actions.

![Image 19: ChatGPT 4o mobile chat replying to “Hey what’s up”](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-bc7baab448365e64b05009d1/299ebaaf1d5324bc9f65cc5df0f0ab46/AD_4nXd0p_mRlTA_FnrPiIV0jH_tzHwCId0GfaySOwJW1KcIPxdMybi8lQNl-QvFbfJE2zn0_tzugcvyqArLXeeuxgz05Yrid11hkGVzsRJF-aD4UQkfjjqriR_jgSMh)
...
*   iOS
    ...
    1.   **Long press to select** text on iOS and moved the message quick actions to always be visible below the message:
        ...
        1.   ![Image 20: ChatGPT iPhone app with selected reply text and the iOS text menu open](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-6616c7acf1e6b07c4375fe8f/ce2f424d3d16f9bd81b314af2d33c8fb/image.png) 
...
![Image 21: iPhone ChatGPT widget with Message ChatGPT plus camera, photo, voice, and microphone shortcuts](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-3c0dd58f7ad0ddc05ac5bbad/ad7b4c2a46951cfed269ea5d73c1e769/Screenshot_2025-02-25_at_4_24_03_E2_80_AFPM.png)
...
![Image 22: Voice recording bar with transcript preview, waveform, and 0:02 duration](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-15d48bb41027ab4c12d734b5/931c3379f4f4c7c245f3e33efbf01af7/image.png)
...
![Image 23: Canvas preview titled Floaty Bubbles With Background with dot text reading SHARING NOW AVAILABLE](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-85f12be24fda84bf8b196e42/0dce6e0340433d92a2b1e9dd089f698c/canvas-sharing-short.gif)
...
![Image 24: Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-6556a8667ac6951f2f100fdd/e1dcf7b0aaf744620825d9ba615b9194/Custom_2BInstructions_2BUI.png)
...
![Image 25: Santa theme card with snowy blue artwork and the subtitle Merry and bright](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-cdaecdf9bcdaa1448f5b5674/2aa198a4a88b028374402cd7a3147b8b/AD_4nXc6Yrl0VAWKWtH0GECNN-FtImdMfgdYXUyrpLVWkA0wLQOlZZ1BnPAF_YhopSPdRZ7B6LwpvwgfoTUBzZXVl5_-L5WpBAYec6oVE4-0-XJ_PPUkx24m3LpAgUAy)
...
![Image 26: Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-1aecb5e619ee51a5b7b85f0e/88e779f0c9a39e87e2e38f0e0af6c173/AD_4nXd1o16dhWtMte7xA2AYZXivAghKAI-r-E0Fc60Lb2g6ftbsr9iIzOjshVrXQcTw5aJtZjWlqd1N3KZ91AvJraYi5TlSSX7xRN5ZXN4uN788H28C9TMPlJ4-sjMC)
...
![Image 28: ChatGPT composer with the tools menu open, highlighting Picture for DALL·E](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-8ae5b85edc783ff22ef6a4ef/324f2a5e22eab8f161700fa74c8c9ba5/AD_4nXf1UN0qvbHRoZi5V28X86BH614j43lPiYI9VFry3u0RU8oacZc9JyICW0qBzlZl4iUUiMITDsDHoO_fZJ_2N-8TWBsK_1_8YEYIaDEKpukBT8FgaS4KK6aEl4Po)
...
![Image 29: ChatGPT Settings with Beta features selected and Web browsing and Plugins toggled on](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-412da42b72c5b70efb883b5e/be57ea9e9471945856dd3e210ed2c80b/BetaPanel.png)
...
*   [July 9, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#july-9-2026)
*   [Introducing ChatGPT Work](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#introducing-chatgpt-work)
*   [The new ChatGPT desktop app brings Chat, Work, and Codex together](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#the-new-chatgpt-desktop-app-brings-chat-work-and-codex-together)
*   [Introducing ChatGPT Sites in public beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#introducing-chatgpt-sites-in-public-beta)
*   [Retiring group chats in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-group-chats-in-chatgpt)
*   [Retiring Atlas](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-atlas)
*   [July 8, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#july-8-2026)
*   [Introducing GPT-Live-1 in ChatGPT Voice](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#introducing-gpt-live-1-in-chatgpt-voice)
*   [July 6, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#july-6-2026)
*   [GPT-5.5 Instant Mini in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-55-instant-mini-in-chatgpt)
*   [June 26, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-26-2026)
*   [Personal finance in ChatGPT expands to Plus users and Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#personal-finance-in-chatgpt-expands-to-plus-users-and-android)
*   [Improved dictation in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improved-dictation-in-chatgpt)
*   [Retiring GPT-4.5](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-gpt-45)
*   [June 25, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-25-2026)
*   [Codex Remote GA and DigitalOcean plugin](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-remote-ga-and-digitalocean-plugin)
*   [June 24, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-24-2026)
*   [GPT-5.5 Instant Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-55-instant-update)
*   [June 22, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-22-2026)
*   [Large pastes are now handled as attachments for more plans](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#large-pastes-are-now-handled-as-attachments-for-more-plans)
*   [June 18, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-18-2026)
*   [ChatGPT app experience updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-app-experience-updates)
*   [Web, iOS, and Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web-ios-and-android)
*   [Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web)
*   [iOS](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#ios)
*   [Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#android)
*   [Record & Replay in Codex](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#record-replay-in-codex)
*   [June 17, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-17-2026)
*   [Scheduled tasks in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#scheduled-tasks-in-chatgpt)
*   [June 12, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-12-2026)
*   [Retiring GPT-5.2 models](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-gpt-52-models)
*   [Additional controls for memory summary](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#additional-controls-for-memory-summary)
*   [June 11, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-11-2026)
*   [Codex updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-updates)
*   [June 10, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-10-2026)
*   [Simplified controls in the model picker](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#simplified-controls-in-the-model-picker)
*   [June 8, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-8-2026)
*   [ChatGPT app experience updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-app-experience-updates)
*   [Web, iOS, and Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web-ios-and-android)
*   [Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web)
*   [iOS](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#ios)
*   [Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#android)
*   [June 4, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-4-2026)
*   [Memory that stays more up to date](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#memory-that-stays-more-up-to-date)
*   [Lockdown Mode is now available to all logged-in users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#lockdown-mode-is-now-available-to-all-logged-in-users)
*   [Rolling out ads in the UK](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#rolling-out-ads-in-the-uk)
*   [June 2, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-2-2026)
*   [Active account session controls](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#active-account-session-controls)
*   [June 1, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-1-2026)
*   [Find live jobs and format your resume in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#find-live-jobs-and-format-your-resume-in-chatgpt)
*   [May 29, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-29-2026)
*   [Codex updates: Computer use and remote control for Windows, usage profiles](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-updates-computer-use-and-remote-control-for-windows-usage-profiles)
*   [May 28, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-28-2026)
*   [GPT-5.5 Instant Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-55-instant-update)
*   [Retiring OpenAI o3 and GPT-4.5](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-openai-o3-and-gpt-45)
*   [May 21, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-21-2026)
*   [Codex updates: richer context, goal mode, browser improvements, and remote locked use](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-updates-richer-context-goal-mode-browser-improvements-and-remote-locked-use)
*   [May 15, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-15-2026)
*   [Personal finances in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#personal-finances-in-chatgpt)
*   [May 14, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-14-2026)
*   [Codex remote access from the ChatGPT mobile app](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-remote-access-from-the-chatgpt-mobile-app)
*   [File library expands to Free and Go users, with storage management](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#file-library-expands-to-free-and-go-users-with-storage-management)
*   [May 12, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-12-2026)
*   [More images in answers for Free users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#more-images-in-answers-for-free-users)
*   [May 7, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-7-2026)
*   [Trusted contact in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#trusted-contact-in-chatgpt)
*   [May 5, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#may-5-2026)
*   [Memory sources and more personalized responses in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#memory-sources-and-more-personalized-responses-in-chatgpt)
*   [GPT-5.5 Instant in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-55-instant-in-chatgpt)
*   [ChatGPT for Excel and Google Sheets](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-for-excel-and-google-sheets)
*   [April 30, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-30-2026)
*   [Advanced Account Security in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#advanced-account-security-in-chatgpt)
*   [April 28, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-28-2026)
*   [Easier model selection in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#easier-model-selection-in-chatgpt)
*   [April 22, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-22-2026)
*   [Fast answers in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#fast-answers-in-chatgpt)
*   [ChatGPT for Clinicians](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-for-clinicians)
*   [April 21, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-21-2026)
*   [ChatGPT Images 2.0 in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-images-20-in-chatgpt)
*   [April 16, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-16-2026)
*   [Rolling out ads in Australia, New Zealand, and Canada](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#rolling-out-ads-in-australia-new-zealand-and-canada)
*   [April 9, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-9-2026)
*   [GPT-5.3 Instant mini in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-53-instant-mini-in-chatgpt)
*   [New Pro plan options](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#new-pro-plan-options)
*   [April 8, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-8-2026)
*   [Outlook shared mailboxes and calendars in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#outlook-shared-mailboxes-and-calendars-in-chatgpt)
*   [April 2, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#april-2-2026)
*   [ChatGPT in Apple CarPlay](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-in-apple-carplay)
*   [March 27, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-27-2026)
*   [Updated Box, Notion, Linear, and Dropbox apps](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#updated-box-notion-linear-and-dropbox-apps)
*   [March 26, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-26-2026)
*   [A simplified sidebar on mobile](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#a-simplified-sidebar-on-mobile)
*   [Location Sharing](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#location-sharing)
*   [Plugins in Codex](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#plugins-in-codex)
*   [March 25, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-25-2026)
*   [Large pastes are now handled as attachments](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#large-pastes-are-now-handled-as-attachments)
*   [Google Drive app unification](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#google-drive-app-unification)
*   [March 24, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-24-2026)
*   [Shopping updates in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#shopping-updates-in-chatgpt)
*   [March 23, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-23-2026)
*   [File Library in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#file-library-in-chatgpt)
*   [March 20, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-20-2026)
*   [Codex for Students](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-for-students)
*   [March 19, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-19-2026)
*   [Legacy deep research mode deprecation notice](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#legacy-deep-research-mode-deprecation-notice)
*   [March 18, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-18-2026)
*   [GPT-5.4 mini in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-54-mini-in-chatgpt)
*   [March 17, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-17-2026)
*   [Updates to the model picker in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#updates-to-the-model-picker-in-chatgpt)
*   [Configure more advanced settings](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#configure-more-advanced-settings)
*   [Sunsetting the “Nerdy” base style](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#sunsetting-the-nerdy-base-style)
*   [March 16, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-16-2026)
*   [GPT-5.3 Instant update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-53-instant-update)
*   [March 11, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-11-2026)
*   [Retiring GPT-5.1 models](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-gpt-51-models)
*   [March 10, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-10-2026)
*   [Interactive learning for math and science](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#interactive-learning-for-math-and-science)
*   [Auto top-up for flexible usage credits](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#auto-top-up-for-flexible-usage-credits)
*   [March 5, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-5-2026)
*   [GPT-5.4 Thinking in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-54-thinking-in-chatgpt)
*   [March 4, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-4-2026)
*   [Codex app on Windows](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#codex-app-on-windows)
*   [March 3, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#march-3-2026)
*   [GPT-5.3 Instant Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-53-instant-update)
*   [February 27, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-27-2026)
*   [ChatGPT Web and Android updates: Edit image prompts, share faster, and smoother conversations](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-web-and-android-updates-edit-image-prompts-share-faster-and-smoother-conversations)
*   [Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web)
*   [Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#android)
*   [Bug fixes](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#bug-fixes)
*   [February 25, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-25-2026)
*   [Add sources to your projects from anywhere](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#add-sources-to-your-projects-from-anywhere)
*   [February 20, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-20-2026)
*   [Expanded context window for Thinking](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#expanded-context-window-for-thinking)
*   [February 19, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-19-2026)
*   [Interactive Code Blocks in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#interactive-code-blocks-in-chatgpt)
*   [February 13, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-13-2026)
*   [Retiring GPT-4o and other legacy models](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-gpt-4o-and-other-legacy-models)
*   [ChatGPT updates: Better file uploads, easier copying, and more reliable long chats](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-updates-better-file-uploads-easier-copying-and-more-reliable-long-chats)
*   [Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web)
*   [Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#android)
*   [iOS](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#ios)
*   [Web, iOS, and Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#web-ios-and-android)
*   [February 12, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-12-2026)
*   [ChatGPT Voice Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-voice-update)
*   [February 10, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-10-2026)
*   [Updates to deep research](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#updates-to-deep-research)
*   [GPT-5.2 Instant Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-52-instant-update)
*   [February 9, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-9-2026)
*   [Testing ads in ChatGPT (Free, Go)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#testing-ads-in-chatgpt-free-go)
*   [February 4, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-4-2026)
*   [Update on thinking time settings for GPT-5.2 Thinking in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#update-on-thinking-time-settings-for-gpt-52-thinking-in-chatgpt)
*   [February 2, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-2-2026)
*   [Introducing the Codex app](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#introducing-the-codex-app)
*   [January 30, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-30-2026)
*   [More visual responses](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#more-visual-responses)
*   [January 29, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-29-2026)
*   [Retiring GPT-4o and other legacy models](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#retiring-gpt-4o-and-other-legacy-models)
*   [January 26, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-26-2026)
*   [Improvements to search response quality in Voice](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improvements-to-search-response-quality-in-voice)
*   [January 22, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-22-2026)
*   [5.2 Personality System Prompt Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#52-personality-system-prompt-update)
*   [January 20, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-20-2026)
*   [Voice Updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#voice-updates)
*   [Rolling out age prediction](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#rolling-out-age-prediction)
*   [January 15, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-15-2026)
*   [Improved memory for finding details from past chats (Plus & Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improved-memory-for-finding-details-from-past-chats-plus-pro)
*   [January 12, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-12-2026)
*   [Dictation Updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#dictation-updates)
*   [January 7, 2026](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-7-2026)
*   [Health in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#health-in-chatgpt)
*   [December 22, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-22-2025)
*   [Your Year with ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#your-year-with-chatgpt)
*   [December 19, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-19-2025)
*   [New detailed characteristic controls](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#new-detailed-characteristic-controls)
*   [December 18, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-18-2025)
*   [Introducing the app directory in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#introducing-the-app-directory-in-chatgpt)
*   [Pinned chats in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#pinned-chats-in-chatgpt)
*   [December 17, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-17-2025)
*   [Tasks are now in Pulse](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#tasks-are-now-in-pulse)
*   [December 16, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-16-2025)
*   [ChatGPT Images on Web and Mobile (iOS & Android)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-images-on-web-and-mobile-ios-android)
*   [December 11, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-11-2025)
*   [Voice on macOS desktop app is retiring (effective January 15, 2026)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#voice-on-macos-desktop-app-is-retiring-effective-january-15-2026)
*   [December 11, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#december-11-2025)
*   [November 25, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-25-2025)
*   [An improved Voice interface: the audio you know, with text and visuals when you need them.](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#an-improved-voice-interface-the-audio-you-know-with-text-and-visuals-when-you-need-them)
*   [November 24, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-24-2025)
*   [Shopping research in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#shopping-research-in-chatgpt)
*   [November 21, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-21-2025)
*   [More images in answers](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#more-images-in-answers)
*   [November 20, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-20-2025)
*   [Instant Checkout now rolling out to Shopify merchants](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#instant-checkout-now-rolling-out-to-shopify-merchants)
*   [November 19, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-19-2025)
*   [GPT-5.1 Pro: Clearer, more capable answers for complex work](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-51-pro-clearer-more-capable-answers-for-complex-work)
*   [November 13, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-13-2025)
*   [Group chats in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#group-chats-in-chatgpt)
*   [November 12, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-12-2025)
*   [GPT-5.1 in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#gpt-51-in-chatgpt)
*   [New tone and personalization controls](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#new-tone-and-personalization-controls)
*   [November 7, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-7-2025)
*   [Personality and custom instructions now apply to all chats](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#personality-and-custom-instructions-now-apply-to-all-chats)
*   [November 5, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-5-2025)
*   [Interrupt ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#interrupt-chatgpt)
*   [November 3, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#november-3-2025)
*   [ChatGPT Go Promo - India](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-go-promo-india)
*   [October 30, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-30-2025)
*   [ChatGPT Go expansion](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-go-expansion)
*   [Credits for Flexible Usage for Codex and Sora](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#credits-for-flexible-usage-for-codex-and-sora)
*   [October 29, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-29-2025)
*   [ChatGPT Pulse on Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-pulse-on-web)
*   [October 28, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-28-2025)
*   [ChatGPT Go now available in Brazil](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-go-now-available-in-brazil)
*   [October 23, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-23-2025)
*   [Shared projects](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#shared-projects)
*   [October 22, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-22-2025)
*   [October 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-15-2025)
*   [ChatGPT can now automatically manage saved memories so it’s even better at remembering what’s important to you.](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-can-now-automatically-manage-saved-memories-so-its-even-better-at-remembering-whats-important-to-you)
*   [October 14, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-14-2025)
*   [ChatGPT Go expansion](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-go-expansion)
*   [October 13, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-13-2025)
*   [Slack connector and app](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#slack-connector-and-app)
*   [October 9, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-9-2025)
*   [Adding Notion & Linear synced connectors](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#adding-notion-linear-synced-connectors)
*   [October 8, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-8-2025)
*   [ChatGPT Go expansion](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#chatgpt-go-expansion)
*   [October 6, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-6-2025)
*   [Updates to Codex](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#updates-to-codex)
*   [October 3, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#october-3-2025)
*   [Updating GPT-5](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#updating-gpt-5)
*   [September 29, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ddcfc706d7)
*   [Parental Controls](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a357acf5ac)
*   [Introducing Instant Checkout and the Agentic Commerce Protocol](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_50b9ee9002)
*   [Instant Checkout](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#instant-checkout)
*   [Agentic Commerce Protocol](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#agentic-commerce-protocol)
*   [September 25, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f5b2a9d2d9)
*   [Introducing ChatGPT Pulse for Pro users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_55c2532a96)
*   [September 22, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8d575159f0)
*   [ChatGPT Go now available in Indonesia](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e04f664a8c)
*   [September 18, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_25d70048e5)
*   [Voice Updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0b79c9b612)
*   [September 17, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_342bdf4198)
*   [Toggle thinking time in the message composer](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_31db500f30)
*   [What’s new](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#whats-new)
*   [How it works](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#how-it-works)
*   [Why we’re making this change](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#why-were-making-this-change)
*   [What’s next](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#whats-next)
*   [September 16, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_85256807be)
*   [Improvements to search in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_adc59d257e)
*   [September 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_aa0a38795e)
*   [Personalization settings are now in Settings](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_027e9df930)
*   [Updates to Codex (Plus/Pro) - Introducing GPT-5-Codex](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_afbf70c9c0)
*   [September 9, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_5908fc253f)
*   [ChatGPT Voice Update](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_81a147a2c1)
*   [September 4, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3fc59dbd59)
*   [Branch conversations on web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a0d1605009)
*   [September 3, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_67d4e675aa)
*   [Projects Now Available on ChatGPT Free Tier](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_982d3e505d)
*   [August 27, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_70047e37a1)
*   [Updates to Codex (Plus/Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_dcaac4ec67)
*   [August 22, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_fb3ac52750)
*   [Project-only memory](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_76ef02082f)
*   [August 18, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e1f5670d6b)
*   [Introducing ChatGPT Go](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_22cae6eb9f)
*   [August 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ffd09f76a2)
*   [GPT-5 Updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6b1adafe01)
*   [August 13, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_bb6f66afc4)
*   [Gmail, Google Calendar, and Google Contacts Connectors in ChatGPT (Plus)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_aa2c316cd4)
*   [August 12, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_bb6f66afc4)
*   [GPT-5 Updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_7e1d4f8bf8)
*   [Gmail, Google Calendar, and Google Contacts Connectors in ChatGPT (Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4da46a695f)
*   [August 11, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_12f820b41c)
*   [Additional connectors for Plus and Pro](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8bd863b7b4)
*   [August 8, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f3863e4727)
*   [Image generation update to ChatGPT Free](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c71943ef9f)
*   [August 7, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_b246595851)
*   [GPT-5](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_57ea59e232)
*   [Personalities](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_1bd35bc38d)
*   [Accent Colors](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3700829e81)
*   [ChatGPT Voice updates](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_5bbf1ce31d)
*   [July 29, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_24bcbfdb6f)
*   [Study Mode](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c2b3700ded)
*   [July 24, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_cf8fe5ea51)
*   [Canva and Notion connectors (Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4a5fe30df9)
*   [Chat search for HubSpot and custom connectors (MCP) (Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9fb0469813)
*   [July 17, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_227a3a02c0)
*   [Updates to Advanced Voice Mode for Free tier users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d66fe4f65b)
*   [July 16, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a1ced17590)
*   [Record mode in ChatGPT macOS desktop app (Plus)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3bfabcc648)
*   [June 24, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#june-24-2025)
*   [Chat search connectors (Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_fab7aa1610)
*   [Project file limit increased (Pro)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f2f58eebf7)
*   [June 18, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9e009b6b34)
*   [ChatGPT record mode](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_2e5af39d39)
*   [June 16, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_dc23b72374)
*   [Expanded Model Support for Custom GPTs](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6899618be6)
*   [June 13, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_dc23b72374)
*   [Improvements to the ChatGPT search response quality](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ad67f97a87)
*   [Improved quality](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improved-quality)
*   [Improved search capability and instruction following](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improved-search-capability-and-instruction-following)
*   [Known limitations](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#known-limitations)
*   [June 12, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3e3aa13dfa)
*   [Expanded Model Support for Custom GPTs](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_783ac074f6)
*   [Adding More Capabilities to Projects](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4c7f139c2c)
*   [June 10, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_db59bda53c)
*   [Today, we're launching OpenAI o3-pro—available now for Pro users in ChatGPT and in our API.](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6c98aab643)
*   [June 7, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d1dfd7dad4)
*   [Updates to Advanced Voice Mode for paid users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_7c3277c4c6)
*   [Known Limitations](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#known-limitations)
*   [June 4, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c0f001f4d0)
*   [Connectors in beta for deep research (Plus, Pro, Team, Enterprise, Edu)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e4a3260e98)
*   [Custom connectors via Model Context Protocol (Pro, Team, Enterprise, Edu)](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f5dbd569f6)
*   [June 3, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_33666b153b)
*   [Memory is now more comprehensive for Free users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_252f356852)
*   [Opt‑in reminders](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#optin-reminders)
*   [May 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ddb7704ab0)
*   [Dropbox connector for deep research for Plus/Pro/Team](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_69ed24df34)
*   [GitHub connector for deep research](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3bd25f14ad)
*   [May 14, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ddb7704ab0)
*   [Releasing GPT-4.1 in ChatGPT for all paid users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_abf8995b3f)
*   [Introducing GPT-4.1 mini, replacing GPT-4o mini, in ChatGPT for all users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d98772a9ea)
*   [May 12, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_95bc392649)
*   [Microsoft Sharepoint and OneDrive connector for deep research for Plus/Pro/Team](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_bf4e42247f)
*   [Export Deep Research as PDF for Plus/Pro/Team](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ba8c5e493c)
*   [May 8, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_2a285b2c97)
*   [GitHub connector for deep research for Plus/Pro/Team](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4a35adaaa7)
*   [Enhanced Memory in ChatGPT (including EU) on Plus/Pro](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_b2d3baff8f)
*   [Plan differences](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e531ab9ed6)
*   [Opt‑in reminders](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0f0df9f1e6)
*   [May 6, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_acfe64e63a)
*   [Mobile UI (iOS/Android) changing on Free/Plus/Pro plans](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_06962b5dbb)
*   [May 1, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9fbded14bb)
*   [Sunsetting Monday GPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_cb831e8531)
*   [April 29, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8497c8b1d4)
*   [Updates to GPT-4o](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_34439eda3a)
*   [April 25, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c03c420095)
*   [Improvements to GPT-4o](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d91a021622)
*   [April 16, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_40089b1bfc)
*   [o3 and o4-mini in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0f7524107c)
*   [Memory with Search](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_91933c7e57)
*   [April 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_707801a904)
*   [ChatGPT Image Library](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_51475eb129)
*   [April 10, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_cbb2e4f019)
*   [Sunsetting GPT‑4 in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a22eaafec2)
*   [March 27, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_10dcfa2a17)
*   [Improvements to GPT-4o](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#improvements-to-gpt-4o)
*   [Smarter problem-solving in STEM and coding:](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#smarter-problem-solving-in-stem-and-coding)
*   [Enhanced instruction-following and formatting accuracy:](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#enhanced-instruction-following-and-formatting-accuracy)
*   [“Fuzzy” improvements:](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#fuzzy-improvements)
*   [March 18, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_70ce7542eb)
*   [Web and the Windows desktop app](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_556fc71a28)
*   [Android App](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4684e4f3d2)
*   [iOS App](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_12a3315bc9)
*   [February 28, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_58c020a59f)
*   [February 21, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_375aa0aec5)
*   [February 14, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0776d514e7)
*   [February 6, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#february-6-2025)
*   [Canvas sharing](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_54c46b74c5)
*   [January 17, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#january-17-2025)
*   [More personalization in Custom Instructions](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_407213a48f)
*   [January 15, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_710fb9ad37)
*   [Import from Chat into Canvas](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_db21108595)
*   [January 14, 2025](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c16236d0f4)
*   [Scheduled tasks in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4b6da11720)
*   [December 13, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d673004b21)
*   [Projects in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_25fd60fd15)
*   [Dec 12, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_97cfc3cc7b)
*   [Santa Voice and Video and Screen Share in Voice Chats](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_45b0e6f55e)
*   [Dec 10, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_741ff7bb70)
*   [Canvas](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_72c532e4b9)
*   [Nov 22, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4082a8d7d4)
*   [Updates to the ChatGPT Web experience](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_60c888bb1b)
*   [Sidebar redesign](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8b3d2f5c4b)
*   [Other updates for ChatGPT on Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c515610a94)
*   [Improved Mobile Web Experience](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d430f75e94)
*   [Nov 19, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_772c9094ce)
*   [Advanced Voice for ChatGPT Web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e9c0cda552)
*   [Aug 8, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_887d23daa0)
*   [DALL·E 3 for ChatGPT Free users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_de294f0730)
*   [July 18, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_16a383ac68)
*   [Introducing GPT-4o mini](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_5ce52d9f14)
*   [May 16, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_dc3149dd8f)
*   [Improvements to data analysis in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_78b6147826)
*   [May 13, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f78ba9fcea)
*   [Introducing GPT-4o](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3cb68a1d55)
*   [Apr 29, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_7d632a28d8)
*   [Memory is now available to Plus users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d8b5710502)
*   [Apr 1, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_94cc122322)
*   [Start using ChatGPT instantly](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_126f2fa257)
*   [Feb 13, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_bb44cfbba6)
*   [Memory and new controls for ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_30ceb8d7ba)
*   [Jan 10, 2024](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8f084b7228)
*   [Introducing the GPT Store and ChatGPT Team plan](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a94a35a825)
*   [November 21, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8a65fe3dbc)
*   [ChatGPT with voice is available to all users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_3fb903d2d0)
*   [November 6, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0ca140a107)
*   [Introducing GPTs](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_61daed3949)
*   [October 17, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_7b4cec3184)
*   [Browsing is now out of beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6401b89b6b)
*   [October 16, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_8670d7da97)
*   [DALL·E 3 is now rolling out in beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_d94d1efdaf)
*   [September 27, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_805a67823e)
*   [Browsing is rolling back out to Plus users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4799933861)
*   [September 25, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6deaf34f13)
*   [New voice and image capabilities in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e3a2ee7903)
*   [September 11, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9ae4c7960a)
*   [ChatGPT language support - Alpha on web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_2235297035)
*   [August 28, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_1b037d6892)
*   [Introducing ChatGPT Enterprise](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9c2276ca4e)
*   [August 21, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_19cebd4cbc)
*   [Custom instructions are now available to users in the EU & UK](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e5d13591f0)
*   [August 9, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_fefd39b6b2)
*   [Custom instructions are now available to free users](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_88eefa0552)
*   [August 3, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9776d9caa7)
*   [Updates to ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_c761ea2ff1)
*   [July 25, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_6198f05897)
*   [Introducing the ChatGPT app for Android](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_74577ea413)
*   [July 20, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e19f92aa23)
*   [Custom instructions are rolling out in beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_647a58ba8a)
*   [July 19, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_4bba4579d2)
*   [Higher message limits for GPT-4](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e65b44764b)
*   [July 6, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_94bd91c819)
*   [Code interpreter is now rolling out in beta on web](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_398fb5df55)
*   [July 3, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ba53776807)
*   [Browsing is temporarily disabled](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_91d1350d34)
*   [June 22, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_ec6c3400a5)
*   [Browsing and search on mobile](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_b444a710ea)
*   [May 24, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_291e1105ff)
*   [iOS app available in more countries, shared links in alpha, Bing Plugin, disable history on iOS](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_461971b989)
*   [May 12, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_a954e45f02)
*   [Web browsing and Plugins are now rolling out in beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_9894d7b0a4)
*   [May 3, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_5a840e423b)
*   [Updates to ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_2818247821)
*   [March 23, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_25947587df)
*   [Introducing plugins in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_98b0bcf5a4)
*   [March 14, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_814575eff8)
*   [Announcing GPT-4 in ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0eb2784e11)
*   [Feb 13, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_cf1475b532)
*   [Updates to ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_71fed9b7cb)
*   [Feb 9 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_72f2be58d5)
*   [Introducing ChatGPT Plus](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_0be048126c)
*   [Jan 30, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f452fb96cc)
*   [Factuality and mathematical improvements](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_f46bd1d771)
*   [Jan 9, 2023](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_bd3d8ef1eb)
*   [Updates to ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_b1c7f24762)
*   [Dec 15, 2022](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_e18c6a1b3a)
*   [Performance updates to ChatGPT](https://help.openai.com/en/articles/6825453-chatgpt-release-notes#h_026e1e86a4)

![Image 30: OpenAI logo](https://help.openai.com/favicon.png)[ChatGPT](https://chatgpt.com/)[API](https://platform.openai.com/docs/)[Service Status](https://status.openai.com/)Cookie Preferences
